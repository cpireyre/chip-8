...
/* TODO:
 * Get the rand() call out out out
 * ref: https://nullprogram.com/blog/2019/04/30/
 * ref: https://www.pcg-random.org/download.html
 * Should go in the platform layer anyway
 */
